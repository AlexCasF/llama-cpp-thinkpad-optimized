...
model_file="Huihui-Ling-mini-2.0-abliterated.Q4_K_S.gguf"
model_path="$model_dir/$model_file"
partial_model_path="$model_path.part"
model_url="https://huggingface.co/mradermacher/Huihui-Ling-mini-2.0-abliterated-GGUF/resolve/main/${model_file}?download=true"
expected_model_size=9302853088
expected_model_sha256="f80fb22a69b33c019a7e127bd8aa2ee9607b885b1a9dccb9f7d00e9fec3274d2"
model_size_gib="9.3"
...
ensure_model() {
    ...
    log "Downloading the verified ${model_size_gib} GiB Ling-mini model. This is resumable..."
...
log "Profile: Ryzen 9 8945HS / Radeon 780M / Ling-mini 2.0"
